...
import { FluentBundle, FluentResource, FluentVariable } from '../fluent_bundle/index.ts';
import { Pattern } from '../fluent_bundle/ast.ts';
import { negotiateLanguages } from '../langneg/index.ts';
